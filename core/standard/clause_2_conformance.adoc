...
* <<rc_mlt,MapLibre Vector Tiles>> (http://www.opengis.net/spec/ogcapi-tiles-1/1.0/req/mlt)
...
|<<rc_mlt,MapLibre Vector Tiles>> |http://www.opengis.net/spec/ogcapi-tiles-1/1.0/conf/mlt
|===
