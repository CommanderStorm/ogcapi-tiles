...
* For features, the media type of the response may be GeoJSON (application/geo+json), Mapbox Vector Tiles (application/vnd.mapbox-vector-tile) or MapLibre Vector Tiles (application/vnd.maplibre-vector-tile);
